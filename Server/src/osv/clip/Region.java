...
public class Region {
	...
	private static final WorldObject[] EXISTANT_OBJECTS = { 
			...
			// RFD
			new WorldObject(12309, 3219, 9623, 0, 1), new WorldObject(12355, 3218, 9621, 0, 0),
			// Resource area
			...
			new WorldObject(7813, 3001, 3372, 0, 2), new WorldObject(7674, 2999, 3373, 0, 0),
			new WorldObject(18819, 3003, 3372, 0, 0),
			// Barrows
			...
			new WorldObject(1753, 3355, 9645, 1, 1),
				//Trapdoor
			new WorldObject(14880, 3356, 9640, 1, 0),
				//Teleportation device
			new WorldObject(13641, 3363, 9640, 1, 0),
				//Banks
			...
			for (int i = 0; i < size; i++) {
				...
				try {
					...
					System.out.println("Error loading map region: "
							+ regionIds[i] + ", objectFile: " + mapObjectsFileIds[i] + ", floorFile: " + mapGroundFileIds[i]);
					e.printStackTrace();
				}
			}
