	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case FIRST_CLICK:
			...
			if (c.getRights().isOrInherits(Right.OWNER)) {
				Misc.println("[DEBUG] NPC Option #1-> Click index: " +c.npcClickIndex + ", NPC Id: " + c.npcType);
			}
		...
		case SECOND_CLICK:
			...
			if (c.getRights().isOrInherits(Right.OWNER)) {
				Misc.println("[DEBUG] NPC Option #2-> Click index: " +c.npcClickIndex + ", NPC Id: " + c.npcType);
			}
			if (NPCHandler.npcs[c.npcClickIndex] != null)
				c.npcType = NPCHandler.npcs[c.npcClickIndex].npcType;
			if (c.goodDistance(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY(),
		...
		case THIRD_CLICK:
			...
			if (c.getRights().isOrInherits(Right.OWNER)) {
				Misc.println("[DEBUG] NPC Option #3-> Click index: " +c.npcClickIndex + ", NPC Id: " + c.npcType);
			}
			if (NPCHandler.npcs[c.npcClickIndex] != null)
				c.npcType = NPCHandler.npcs[c.npcClickIndex].npcType;
			if (c.goodDistance(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY(),
		...
		case FOURTH_CLICK:
			...
			if (c.getRights().isOrInherits(Right.OWNER)) {
				Misc.println("[DEBUG] NPC Option #4-> Click index: " +c.npcClickIndex + ", NPC Id: " + c.npcType);
			}
			if (c.getInterfaceEvent().isActive()) {
				c.sendMessage("Please finish what you're doing.");
				return;
