...
public enum Tree {
	NORMAL(new int[] { 1276, 1278 }, 1342, 1511, 1, 5, 20, 25, 15, 12000), 
	...
	MAGIC(new int[] { 1761, 11764 }, 1356, 1513, 75, 20, 125, 250, 75, 8600), 
	REDWOOD(new int[] { 28859 }, 28860, 19669, 90, 35, 125, 380, 60, 8400);
