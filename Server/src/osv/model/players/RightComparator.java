...
import osv.database.players_online.PlayerOnlineEntry;
...
public class RightComparator implements Comparator<Right> {
	...
	public static final Comparator<PlayerOnlineEntry> PLAYER_ONLINE_COMPARATOR = new Comparator<PlayerOnlineEntry>() {

		@Override
		public int compare(PlayerOnlineEntry entry1, PlayerOnlineEntry entry2) {
			return RIGHT_COMPARATOR.compare(entry1.getRight(), entry2.getRight());
		}
	};
