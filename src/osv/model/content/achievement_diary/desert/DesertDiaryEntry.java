package osv.model.content.achievement_diary.desert;
...
public enum DesertDiaryEntry {
	...
	KILL_LIZARDS_DESERT("Kill some lizards: %totalstage", 40),
	MINE_CLAY("Mine some clay in the north-eastern part of the desert"),
	
	//Medium
	KILL_BANDIT("Kill some bandits: %totalstage", 150),
	...
	CAST_BARRAGE("Cast ice barrage against a foe in the desert"),
	KILL_VULTURE("Kill some vultures: %totalstage", 140),
