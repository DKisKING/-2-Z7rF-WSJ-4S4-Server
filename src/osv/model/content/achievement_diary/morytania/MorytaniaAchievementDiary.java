package osv.model.content.achievement_diary.morytania;

import static osv.model.content.achievement_diary.morytania.MorytaniaDiaryEntry.*;
...
public final class MorytaniaAchievementDiary extends StatefulAchievementDiary<MorytaniaDiaryEntry>{
	...
	public final void display() {
		...
		player.getPA().sendFrame126(hasCompleted("ELITE") ? "@blu@<str=1>Elite</str>" : "@blu@Elite", 8160);
