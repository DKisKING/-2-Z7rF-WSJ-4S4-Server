package osv.model.players.skills.herblore;
...
public class PotionData {
	...
	public enum FinishedPotions {
		...
		ANTIFIRE(new GameItem(2452), 69, 157, new GameItem(2483), new GameItem(243)), 
		...
		WEAPON_POISON(new GameItem(187), 60, 137, new GameItem(105), new GameItem(243)), 
