...
//			}
		...
		case 4:
			...
			break;
		case 7:
			sendNpcChat("There you go veldaharian, goodjob.");
			c.nextChat = -1;
			break;
...
//			break;
		...
		case 645:
			sendNpcChat("Welcome to OS-Veldahar.", "You have the option to play as an <col=" + Right.IRONMAN.getColor() + "><img=12></img>Iron Man</col>,",
