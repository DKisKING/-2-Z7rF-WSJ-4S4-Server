package osv.model.multiplayer_session.duel;
...
public class DuelSession extends MultiplayerSession {
	...
	private String createQuery(ArrayList<Entry<Player, String>> participantList, MultiplayerSessionFinalizeType type) {
		...
		String query = "INSERT into stakes (DATE, STAKESTATUS, WINNER, PLAYER, IP, STAKED, OTHERPLAYER, OTHERIP, OTHERSTAKED) VALUES(NOW(), '" + status + "', '"
				+ winner.get().playerName + "', '" + player.playerName + "', '" + getIp(player) + "', '" + items + "', '" + playerOther.playerName + "', '" + getIp(playerOther)
				+ "', '" + itemsOther + "')";
		return query;
	}
